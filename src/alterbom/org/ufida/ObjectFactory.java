...
public class ObjectFactory {
    ...
    private final static QName _DoBOMMasterDTOList_QNAME = new QName("http://www.UFIDA.org", "bOMMasterDTOList");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.UFIDA.org", name = "bOMMasterDTOList", scope = Do.class)
    public JAXBElement<ArrayOfUFIDAU9ISVMFGBOMBOMMasterDTO4CreateSvData> createDoBOMMasterDTOList(ArrayOfUFIDAU9ISVMFGBOMBOMMasterDTO4CreateSvData value) {
        return new JAXBElement<ArrayOfUFIDAU9ISVMFGBOMBOMMasterDTO4CreateSvData>(_DoBOMMasterDTOList_QNAME, ArrayOfUFIDAU9ISVMFGBOMBOMMasterDTO4CreateSvData.class, Do.class, value);
    }
    ...
    public JAXBElement<ArrayOfUFIDAU9ISVMFGBOMLogDTO4CreateSvData> createDoResponseDoResult(ArrayOfUFIDAU9ISVMFGBOMLogDTO4CreateSvData value) {
        return new JAXBElement<ArrayOfUFIDAU9ISVMFGBOMLogDTO4CreateSvData>(_DoResponseDoResult_QNAME, ArrayOfUFIDAU9ISVMFGBOMLogDTO4CreateSvData.class, DoResponse.class, value);
    }
