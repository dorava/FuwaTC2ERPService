...
public class ObjectFactory {
    ...
    private final static QName _DoItemCode_QNAME = new QName("http://www.UFIDA.org", "itemCode");
    private final static QName _DoBomVersion_QNAME = new QName("http://www.UFIDA.org", "bomVersion");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.UFIDA.org", name = "itemCode", scope = Do.class)
    public JAXBElement<String> createDoItemCode(String value) {
        return new JAXBElement<String>(_DoItemCode_QNAME, String.class, Do.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.UFIDA.org", name = "bomVersion", scope = Do.class)
    public JAXBElement<String> createDoBomVersion(String value) {
        return new JAXBElement<String>(_DoBomVersion_QNAME, String.class, Do.class, value);
    }
