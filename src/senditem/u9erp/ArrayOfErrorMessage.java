...
@XmlType(name = "ArrayOfErrorMessage", namespace = "http://schemas.datacontract.org/2004/07/UFSoft.UBF", propOrder = {
    "errorMessage"
})
public class ArrayOfErrorMessage {

    @XmlElement(name = "ErrorMessage", namespace = "http://schemas.datacontract.org/2004/07/UFSoft.UBF", nillable = true)
