...
public class ObjectFactory {
    ...
    private final static QName _ArrayOfMessageBase_QNAME = new QName("UFSoft.UBF.Exceptions", "ArrayOfMessageBaseDif1");
    private final static QName _MessageBase_QNAME = new QName("UFSoft.UBF.Exceptions", "MessageBaseDif1");
     ...
     * 
     */
    @XmlElementDecl(namespace = "UFSoft.UBF.Exceptions", name = "ArrayOfMessageBaseDif1")
     ...
     * 
     */
    @XmlElementDecl(namespace = "UFSoft.UBF.Exceptions", name = "MessageBaseDif1")
